...
export default function VBACCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      intro={<>Considering a vaginal birth after a previous C-section? This calculator helps estimate your success probability based on factors like age, <a href="/womens-bmi-calculator" className="text-primary hover:underline font-medium">BMI</a>, and previous birth history, based on the Grobman nomogram.</>}
      schema={[
