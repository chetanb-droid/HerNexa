    ...
    <div className="space-y-24 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          ...
          <a href="/tools" className="text-primary font-bold hover:text-primary/80 flex items-center gap-2" aria-label="See all 30 plus tools">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <a key={i} href={tool.path} className="group bg-white border border-neutral-100 rounded-[2rem] p-8 hover:shadow-xl hover:border-primary/20 transition-all" aria-label={`Go to ${tool.title}`}>
