...
export default function BBTAnalyzer() {
  ...
  return (
    <CalculatorLayout
      title="BBT Analyzer & Charting Tool | Fertility Calculator"
      ...
      medicalReferences={[
        {
          title: "Basal Body Temperature for Monitoring Ovulation",
        ...
        },
        {
          ...
          url: "https://en.wikipedia.org/wiki/Basal_body_temperature",
          source: "Wikipedia"
        }
      ]}
      results={results && (
        ...
        >
          ...
          <div className="bg-primary/5 p-6 rounded-2xl border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4 mt-8">
            <div>
              ...
              <p className="text-sm text-text-medium">Continue your health journey with our Cervical Mucus Tracker.</p>
            </div>
            <a href="/cervical-mucus-tracker" className="btn-primary whitespace-nowrap px-6 py-2 text-sm">
              Cervical Mucus Tracker &rarr;
            </a>
          </div>
        </motion.div>
      )}
