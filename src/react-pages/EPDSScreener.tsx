...
export default function EPDSScreener() {
  ...
  return (
    <CalculatorLayout
      ...
      intro={<><a href="/postpartum-depression-screener" className="text-primary hover:underline font-medium">Postpartum depression</a> is common and treatable. This tool uses the Edinburgh Postnatal Depression Scale to help you screen for symptoms.</>}
      schema={[
