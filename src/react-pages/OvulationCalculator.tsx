...
export default function OvulationCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      intro={<>Trying to conceive? Our clinical ovulation calculator (or <strong>fertility estimator</strong>) helps you identify the <strong className="font-bold">best time to get pregnant</strong> by analyzing your <a href="/period-calculator" className="text-primary hover:underline font-medium">menstrual cycle</a>. By tracking the first day of your last period and your average <a href="/menstrual-cycle-length-calculator" className="text-primary hover:underline font-medium">cycle length</a>, you can pinpoint the absolute <strong>best days to get pregnant calculator</strong> estimates based on standard obstetric guidelines. Stop wondering "when to have sex to get pregnant" and use our tool to track your peak fertility!</>}
      schema={[
      ...
      results={results && (
        ...
        >
          ...
          <div className="bg-primary/5 p-6 rounded-2xl border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a href="/time-to-conceive-calculator" className="btn-primary whitespace-nowrap px-6 py-2 text-sm">
