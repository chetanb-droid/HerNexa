...
export default function DueDateCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      howItWorks={
        <>
          <p>This calculator utilizes standardized obstetric formulas to determine your Estimated Due Date (EDD) and <a href="/pregnancy-week-calculator" className="text-primary hover:underline font-medium">gestational age</a>:</p>
          <ul className="list-disc pl-5 mt-2 space-y-2">
            <li><strong>Naegele's Rule (LMP):</strong> The standard obstetric method which adds 280 days (40 weeks) to the first day of your last menstrual period. Our calculator dynamically adjusts this based on your specific <a href="/menstrual-cycle-length-calculator" className="text-primary hover:underline font-medium">cycle length</a> (e.g., adding days for cycles longer than 28 days).</li>
      ...
      results={results && (
        <div className="space-y-8">
          ...
          <div className="bg-primary/5 p-6 rounded-2xl border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a href="/baby-size-comparator" className="btn-primary whitespace-nowrap px-6 py-2 text-sm">
