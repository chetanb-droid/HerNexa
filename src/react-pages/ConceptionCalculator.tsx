...
export default function ConceptionCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      intro={<>Determining the exact date of conception is a common question for expectant parents. While it's difficult to pinpoint the exact minute, this clinical calculator works backwards from your Estimated <a href="/due-date-calculator" className="text-primary hover:underline font-medium">Due Date</a> (EDD) or Last Menstrual Period (LMP) to identify the most probable window of fertilization, providing insight into the very beginning of embryonic development. Understanding your <a href="/ovulation-calculator" className="text-primary hover:underline font-medium">ovulation cycle</a> is key to this calculation. If you are still trying to get pregnant, you can also use this as a <strong>when to have sex to conceive calculator</strong> to plan ahead. Note that our tool does not serve as a <strong>how to conceive a baby girl naturally calculator</strong>, as intercourse timing methods for gender selection are not scientifically validated.</>}
      schema={[
      ...
      howItWorks={
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong>From Last Menstrual Period (LMP):</strong> If you know your average <a href="/menstrual-cycle-length-calculator" className="text-primary hover:underline font-medium">cycle length</a>, we estimate your ovulation day (typically 14 days before the onset of the next menses, as the luteal phase is relatively constant). Conception almost always occurs within 12-24 hours of ovulation.</li>
