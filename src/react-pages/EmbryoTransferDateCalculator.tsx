...
export default function EmbryoTransferDateCalculator() {
  ...
  return (
    <CalculatorLayout
      ...
      intro={<>If you conceived through IVF (In Vitro Fertilization) or FET (Frozen Embryo Transfer), standard subjective tools using your last menstrual period won't be accurate. This specialized <strong>IVF due date calculator</strong> uses your transfer date and embryo age to provide the most mathematically precise <strong>ivf pregnancy calculator</strong> estimates. Whether you need a <strong>fet due date calculator</strong> or a general <strong>ivf calculator</strong>, tracking your <a href="/due-date-calculator" className="text-primary hover:underline font-medium">due date</a> with precision is critical for the next milestones.</>}
      schema={[
      ...
      results={results && (
        ...
        >
          ...
          <div className="bg-primary/5 p-6 rounded-2xl border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-4 mt-8">
            ...
            <a href="/ivf-success-rate-calculator" className="btn-primary whitespace-nowrap px-6 py-2 text-sm">
