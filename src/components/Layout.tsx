...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-bg-light font-sans text-text-dark overflow-x-hidden">
      ...
      <div className="bg-primary text-white py-2 px-4 text-center text-xs uppercase font-bold tracking-[0.2em]">
      ...
      <footer className="bg-white text-text-medium pt-24 pb-12 border-t border-primary/10">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-12 border-t border-primary/5 space-y-6">
          <div className="text-xs text-text-dark/70 leading-relaxed text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 text-xs uppercase font-bold tracking-widest text-text-dark/60">
            <p>&copy; {new Date().getFullYear()} HerNexa. All rights reserved.</p>
          </div>
          <div className="text-center text-xs font-medium text-text-dark/60 mt-4">
